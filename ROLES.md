...
Consideramos que **Gabriel (Product Manager)** representa a la alta gerencia vinculada al desarrollo del producto.

Si bien participan otros stakeholders especializados, como **Ana** (Head de Entrenadores), **Mara** (Legal) y **Diego** (CTO/DevOps), es Gabriel quien define la estrategia del producto, establece las prioridades del MVP y toma las decisiones relacionadas con el alcance del proyecto.
