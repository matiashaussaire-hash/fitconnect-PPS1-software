...
| **Modelo Ágil (Scrum / XP)** | Favorece la comunicación con el cliente, el trabajo colaborativo y la entrega continua de mejoras durante cada incremento del proyecto. | Si no existe una buena planificación del alcance de cada incremento, pueden producirse cambios constantes que afecten los tiempos de entrega. |
